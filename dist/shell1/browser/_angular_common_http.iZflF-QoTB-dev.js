...
var HttpXhrBackend = class _HttpXhrBackend {
  ...
  handle(req) {
    if (req.method === "JSONP") {
      throw new \u0275RuntimeError(-2800, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot make a JSONP request without JSONP support. To fix the problem, either add the \`withJsonpSupport()\` call (if \`provideHttpClient()\` is used) or import the \`HttpClientJsonpModule\` in the root NgModule.`);
    }
  ...
  static {
    this.\u0275fac = function HttpXhrBackend_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _HttpXhrBackend)(i0.\u0275\u0275inject(i1.XhrFactory));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
...
var HttpXsrfCookieExtractor = class _HttpXsrfCookieExtractor {
  ...
  static {
    this.\u0275fac = function HttpXsrfCookieExtractor_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _HttpXsrfCookieExtractor)(i0.\u0275\u0275inject(DOCUMENT), i0.\u0275\u0275inject(PLATFORM_ID), i0.\u0275\u0275inject(XSRF_COOKIE_NAME));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ i0.\u0275\u0275defineInjectable({
...
function transferCacheInterceptorFn(req, next) {
  ...
  if (originMap && !isServer) {
    throw new \u0275RuntimeError(2803, ngDevMode && "Angular detected that the `HTTP_TRANSFER_CACHE_ORIGIN_MAP` token is configured and present in the client side code. Please ensure that this token is only provided in the server code of the application.");
  }
...
function verifyMappedOrigin(url) {
  if (new URL(url, "resolve://").pathname !== "/") {
    throw new \u0275RuntimeError(2804, `Angular detected a URL with a path segment in the value provided for the \`HTTP_TRANSFER_CACHE_ORIGIN_MAP\` token: ${url}. The map should only contain origins without any other segments.`);
  }
}
export {
  FetchBackend,
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_common_http.iZflF-QoTB-dev.js.map
