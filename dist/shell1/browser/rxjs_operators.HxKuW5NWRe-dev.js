...
function bufferToggle(openings, closingSelector) {
  return operate(function(source, subscriber) {
    ...
    source.subscribe(createOperatorSubscriber(subscriber, function(value) {
      var e_1, _a;
      try {
        for (var buffers_1 = __values5(buffers), buffers_1_1 = buffers_1.next(); !buffers_1_1.done; buffers_1_1 = buffers_1.next()) {
          var buffer2 = buffers_1_1.value;
          buffer2.push(value);
        }
      } catch (e_1_1) {
...
function combineLatest2() {
  ...
  var resultSelector = popResultSelector(args);
  return resultSelector ? pipe(combineLatest2.apply(void 0, __spreadArray5([], __read5(args))), mapOneOrManyArgs(resultSelector)) : operate(function(source, subscriber) {
    combineLatestInit(__spreadArray5([source], __read5(argsOrArgArray(args))))(subscriber);
  });
}
...
function combineLatestWith() {
  ...
  return combineLatest2.apply(void 0, __spreadArray6([], __read6(otherSources)));
}
...
function concat() {
  ...
  var scheduler = popScheduler(args);
  return operate(function(source, subscriber) {
    concatAll()(from(__spreadArray7([source], __read7(args)), scheduler)).subscribe(subscriber);
  });
}
...
function concatWith() {
  ...
  return concat.apply(void 0, __spreadArray8([], __read8(otherSources)));
}

// node_modules/rxjs/dist/esm5/internal/Subject.js
import { __extends as __extends6, __values as __values6 } from "tslib";
  ...
  Subject2.prototype.next = function(value) {
    ...
    errorContext(function() {
      ...
      if (!_this.isStopped) {
        ...
        try {
          for (var _b = __values6(_this.currentObservers), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var AnonymousSubject = function(_super) {
  __extends6(AnonymousSubject2, _super);
...
function endWith() {
  ...
  return function(source) {
    return concat2(source, of.apply(void 0, __spreadArray9([], __read9(values))));
  };
}
...
function merge() {
  ...
  return operate(function(source, subscriber) {
    mergeAll(concurrent)(from(__spreadArray10([source], __read10(args)), scheduler)).subscribe(subscriber);
  });
}
...
function mergeWith() {
  ...
  return merge.apply(void 0, __spreadArray11([], __read11(otherSources)));
}
...
var ConnectableObservable = function(_super) {
  __extends7(ConnectableObservable2, _super);
...
function onErrorResumeNextWith() {
  ...
  var nextSources = argsOrArgArray(sources);
  return function(source) {
    return onErrorResumeNext.apply(void 0, __spreadArray12([source], __read12(nextSources)));
  };
}
...
var BehaviorSubject = function(_super) {
  __extends8(BehaviorSubject2, _super);
...
var AsyncSubject = function(_super) {
  __extends9(AsyncSubject2, _super);
...
var ReplaySubject = function(_super) {
  __extends10(ReplaySubject2, _super);
...
function raceWith() {
  ...
  return !otherSources.length ? identity : operate(function(source, subscriber) {
    raceInit(__spreadArray13([source], __read13(otherSources)))(subscriber);
  });
}
...
function race() {
  ...
  return raceWith.apply(void 0, __spreadArray14([], __read14(argsOrArgArray(args))));
}
    ...
    var _loop_1 = function(sourceIndex2) {
      innerFrom(sources[sourceIndex2]).subscribe(createOperatorSubscriber(subscriber, function(value) {
        ...
        if (buffers.every(function(buffer2) {
          ...
          subscriber.next(resultSelector ? resultSelector.apply(void 0, __spreadArray17([], __read17(result))) : result);
...
function zip2() {
  ...
  return operate(function(source, subscriber) {
    zip.apply(void 0, __spreadArray18([source], __read18(sources))).subscribe(subscriber);
  });
}
...
import { __read as __read19, __spreadArray as __spreadArray19 } from "tslib";
function zipWith() {
  var otherInputs = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    otherInputs[_i] = arguments[_i];
  }
  return zip2.apply(void 0, __spreadArray19([], __read19(otherInputs)));
}
export {
  audit,
  auditTime,
...
//# sourceMappingURL=rxjs_operators.HxKuW5NWRe-dev.js.map
