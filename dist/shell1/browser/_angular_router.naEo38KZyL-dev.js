...
import { \u0275isPromise, \u0275RuntimeError, Injectable, createEnvironmentInjector, \u0275isNgModule, isStandalone, EventEmitter, inject, ViewContainerRef, ChangeDetectorRef as ChangeDetectorRef2, Directive, Input, Output, InjectionToken, reflectComponentType, \u0275isInjectable, runInInjectionContext, Component, Compiler as Compiler2, NgModuleFactory, NgZone as NgZone2, afterNextRender, EnvironmentInjector as EnvironmentInjector2, \u0275Console, \u0275PendingTasks, \u0275\u0275sanitizeUrlOrResourceUrl, booleanAttribute, Attribute, HostBinding, HostListener, Optional, ContentChildren, makeEnvironmentProviders, APP_BOOTSTRAP_LISTENER, ENVIRONMENT_INITIALIZER, Injector, ApplicationRef, InjectFlags, APP_INITIALIZER, SkipSelf, NgModule, Inject, Version } from "@angular/core";
import { isObservable, from, of, BehaviorSubject, combineLatest, EmptyError, concat, defer, pipe, throwError, EMPTY, ConnectableObservable, Subject, Subscription } from "rxjs";
import * as i3 from "@angular/common";
import { DOCUMENT, Location, ViewportScroller as ViewportScroller2, LOCATION_INITIALIZED, LocationStrategy as LocationStrategy2, HashLocationStrategy, PathLocationStrategy } from "@angular/common";
  ...
  constructor(root = new UrlSegmentGroup([], {}), queryParams = {}, fragment = null) {
    ...
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (root.segments.length > 0) {
        throw new \u0275RuntimeError(4015, "The root `UrlSegmentGroup` should not contain `segments`. Instead, these segments belong in the `children` so they can be associated with a named outlet.");
      }
    }
  }
  get queryParamMap() {
...
var UrlParser = class {
  ...
  parseSegment() {
    ...
    if (path === "" && this.peekStartsWith(";")) {
      throw new \u0275RuntimeError(4009, (typeof ngDevMode === "undefined" || ngDevMode) && `Empty path url segment cannot have parameters: '${this.remaining}'.`);
    }
    this.capture(path);
  ...
  parseParens(allowPrimary) {
    ...
    while (!this.consumeOptional(")") && this.remaining.length > 0) {
      ...
      if (next !== "/" && next !== ")" && next !== ";") {
        throw new \u0275RuntimeError(4010, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot parse url '${this.url}'`);
      }
  ...
  capture(str) {
    if (!this.consumeOptional(str)) {
      throw new \u0275RuntimeError(4011, (typeof ngDevMode === "undefined" || ngDevMode) && `Expected "${str}".`);
    }
  }
};
...
var Navigation = class {
  constructor(isAbsolute, numberOfDoubleDots, commands) {
    ...
    if (isAbsolute && commands.length > 0 && isMatrixParams(commands[0])) {
      throw new \u0275RuntimeError(4003, (typeof ngDevMode === "undefined" || ngDevMode) && "Root segment cannot have matrix parameters");
    }
    const cmdWithOutlet = commands.find(isCommandWithOutlets);
    if (cmdWithOutlet && cmdWithOutlet !== last(commands)) {
      throw new \u0275RuntimeError(4004, (typeof ngDevMode === "undefined" || ngDevMode) && "{outlets:{}} has to be the last command");
    }
  }
  toRoot() {
...
function createPositionApplyingDoubleDots(group, index, numberOfDoubleDots) {
  ...
  while (dd > ci) {
    ...
    g = g.parent;
    if (!g) {
      throw new \u0275RuntimeError(4005, (typeof ngDevMode === "undefined" || ngDevMode) && "Invalid number of '../'");
    }
...
function assertStandalone(fullPath, component) {
  if (component && \u0275isNgModule(component)) {
    throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}'. You are using 'loadComponent' with a module, but it must be used with standalone components. Use 'loadChildren' instead.`);
  } else if (component && !isStandalone(component)) {
    throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}'. The component must be standalone.`);
  }
}
function validateNode(route, fullPath, requireStandaloneComponents) {
  if (typeof ngDevMode === "undefined" || ngDevMode) {
    ...
    if (Array.isArray(route)) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': Array cannot be specified`);
    }
    if (!route.redirectTo && !route.component && !route.loadComponent && !route.children && !route.loadChildren && route.outlet && route.outlet !== PRIMARY_OUTLET) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': a componentless route without children or loadChildren cannot have a named outlet set`);
    }
    if (route.redirectTo && route.children) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': redirectTo and children cannot be used together`);
    }
    if (route.redirectTo && route.loadChildren) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': redirectTo and loadChildren cannot be used together`);
    }
    if (route.children && route.loadChildren) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': children and loadChildren cannot be used together`);
    }
    if (route.redirectTo && (route.component || route.loadComponent)) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': redirectTo and component/loadComponent cannot be used together`);
    }
    if (route.component && route.loadComponent) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': component and loadComponent cannot be used together`);
    }
    if (route.redirectTo && route.canActivate) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': redirectTo and canActivate cannot be used together. Redirects happen before activation so canActivate will never be executed.`);
    }
    if (route.path && route.matcher) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': path and matcher cannot be used together`);
    }
    if (route.redirectTo === void 0 && !route.component && !route.loadComponent && !route.children && !route.loadChildren) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}'. One of the following must be provided: component, loadComponent, redirectTo, children or loadChildren`);
    }
    if (route.path === void 0 && route.matcher === void 0) {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': routes must have either a path or a matcher specified`);
    }
    if (typeof route.path === "string" && route.path.charAt(0) === "/") {
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '${fullPath}': path cannot start with a slash`);
    }
    if (route.path === "" && route.redirectTo !== void 0 && route.pathMatch === void 0) {
      const exp = `The default value of 'pathMatch' is 'prefix', but often the intent is to use 'full'.`;
      throw new \u0275RuntimeError(4014, `Invalid configuration of route '{path: "${fullPath}", redirectTo: "${route.redirectTo}"}': please provide 'pathMatch'. ${exp}`);
    }
...
var RouterOutlet = class _RouterOutlet {
  constructor() {
    ...
    this.changeDetector = inject(ChangeDetectorRef2);
  ...
  get component() {
    if (!this.activated)
      throw new \u0275RuntimeError(4012, (typeof ngDevMode === "undefined" || ngDevMode) && "Outlet is not activated");
  ...
  activateWith(activatedRoute, environmentInjector) {
    if (this.isActivated) {
      throw new \u0275RuntimeError(4013, (typeof ngDevMode === "undefined" || ngDevMode) && "Cannot activate an already activated outlet");
    }
    this._activatedRoute = activatedRoute;
...
function namedOutletsRedirect(redirectTo) {
  return throwError(new \u0275RuntimeError(4e3, (typeof ngDevMode === "undefined" || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
...
var ApplyRedirects = class {
  ...
  findPosParam(redirectTo, redirectToUrlSegment, posParams) {
    ...
    if (!pos)
      throw new \u0275RuntimeError(4001, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot redirect to '${redirectTo}'. Cannot find '${redirectToUrlSegment.path}'.`);
    return pos;
  }
...
var Recognizer = class {
  ...
  noMatchError(e) {
    return new \u0275RuntimeError(4002, typeof ngDevMode === "undefined" || ngDevMode ? `Cannot match any routes. URL Segment: '${e.segmentGroup}'` : `'${e.segmentGroup}'`);
  }
  recognize() {
  ...
  expandSegmentAgainstRouteUsingRedirect(injector, segmentGroup, routes, route, segments, outlet, parentRoute) {
    ...
    if (typeof route.redirectTo === "string" && route.redirectTo[0] === "/") {
      ...
      if (this.absoluteRedirectCount > MAX_ALLOWED_REDIRECTS) {
        if (ngDevMode) {
          throw new \u0275RuntimeError(4016, `Detected possible infinite redirect when redirecting from '${this.urlTree}' to '${route.redirectTo}'.
...
function checkOutletNameUniqueness(nodes) {
  ...
  nodes.forEach((n) => {
    ...
    if (routeWithSameOutletName) {
      ...
      throw new \u0275RuntimeError(4006, (typeof ngDevMode === "undefined" || ngDevMode) && `Two segments cannot have the same outlet name: '${p}' and '${c}'.`);
    }
...
var RouterConfigLoader = class _RouterConfigLoader {
  constructor() {
    ...
    this.compiler = inject(Compiler2);
  }
  loadComponent(route) {
...
function createViewTransition(injector, from2, to) {
  ...
  return injector.get(NgZone2).runOutsideAngular(() => {
...
function validateCommands(commands) {
  for (let i = 0; i < commands.length; i++) {
    ...
    if (cmd == null) {
      throw new \u0275RuntimeError(4008, (typeof ngDevMode === "undefined" || ngDevMode) && `The requested path contains ${cmd} segment at index ${i}`);
    }
  }
}
...
var RouterLink = class _RouterLink {
  ...
  ngOnChanges(changes) {
    if (ngDevMode && isUrlTree(this.routerLinkInput) && (this.fragment !== void 0 || this.queryParams || this.queryParamsHandling || this.preserveFragment || this.relativeTo)) {
      throw new \u0275RuntimeError(4016, "Cannot configure queryParams or fragment when using a UrlTree as the routerLink input value.");
    }
    if (this.isAnchorElement) {
      this.updateHref();
    }
...
function withInMemoryScrolling(options = {}) {
  const providers = [{
    ...
    useFactory: () => {
      const viewportScroller = inject(ViewportScroller2);
...
var RouterModule = class _RouterModule {
  ...
  static {
    this.\u0275fac = function RouterModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _RouterModule)(i0.\u0275\u0275inject(ROUTER_FORROOT_GUARD, 8));
    };
  }
  static {
...
function provideForRootGuard(router) {
  if ((typeof ngDevMode === "undefined" || ngDevMode) && router) {
    throw new \u0275RuntimeError(4007, `The Router was provided more than once. This can happen if 'forRoot' is used outside of the root injector. Lazy loaded modules should use RouterModule.forChild() instead.`);
  }
  return "guarded";
}
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_router.naEo38KZyL-dev.js.map
