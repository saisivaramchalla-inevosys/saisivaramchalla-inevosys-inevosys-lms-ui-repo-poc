...
import { Directive, InjectionToken, forwardRef, Optional, Inject, \u0275isPromise, \u0275isSubscribable, \u0275RuntimeError, Self, computed, signal, untracked, EventEmitter, Input, Host, SkipSelf, booleanAttribute, ChangeDetectorRef as ChangeDetectorRef2, Output, Injectable, inject, NgModule, Version } from "@angular/core";
...
function toObservable(value) {
  ...
  if ((typeof ngDevMode === "undefined" || ngDevMode) && !\u0275isSubscribable(obs)) {
    ...
    throw new \u0275RuntimeError(-1101, errorMessage);
  }
  return obs;
}
...
function controlParentException(nameOrIndex) {
  return new \u0275RuntimeError(1050, `formControlName must be used with a parent formGroup directive. You'll want to add a formGroup
...
function ngModelGroupException() {
  return new \u0275RuntimeError(1051, `formControlName cannot be used with an ngModelGroup parent. It is only compatible with parents
...
function missingFormException() {
  return new \u0275RuntimeError(1052, `formGroup expects a FormGroup instance. Please pass one in.
...
function groupParentException() {
  return new \u0275RuntimeError(1053, `formGroupName must be used with a parent formGroup directive.  You'll want to add a formGroup
    directive and pass it an existing FormGroup instance (you can create one in your class).
...
function arrayParentException() {
  return new \u0275RuntimeError(1054, `formArrayName must be used with a parent formGroup directive.  You'll want to add a formGroup
      directive and pass it an existing FormGroup instance (you can create one in your class).
...
function assertControlPresent(parent, isGroup, key) {
  ...
  if (!collection.length) {
    throw new \u0275RuntimeError(1e3, typeof ngDevMode === "undefined" || ngDevMode ? noControlsError(isGroup) : "");
  }
  if (!controls[key]) {
    throw new \u0275RuntimeError(1001, typeof ngDevMode === "undefined" || ngDevMode ? missingControlError(isGroup, key) : "");
  }
}
function assertAllValuesPresent(control, isGroup, value) {
  control._forEachChild((_, key) => {
    if (value[key] === void 0) {
      throw new \u0275RuntimeError(1002, typeof ngDevMode === "undefined" || ngDevMode ? missingControlValueError(isGroup, key) : "");
    }
  });
}
...
function _throwMissingValueAccessorError(dir) {
  ...
  throw new \u0275RuntimeError(-1203, `No value accessor for form control ${loc}.`);
}
function _throwInvalidValueAccessorError(dir) {
  const loc = _describeControlLocation(dir);
  throw new \u0275RuntimeError(1200, `Value accessor was not provided as an array for form control with ${loc}. Check that the \`NG_VALUE_ACCESSOR\` token is configured as a \`multi: true\` provider.`);
}
...
function missingNameException() {
  return new \u0275RuntimeError(1352, `If ngModel is used within a form tag, either the name attribute must be set or the form
...
var SelectControlValueAccessor = class _SelectControlValueAccessor extends BuiltInControlValueAccessor {
  ...
  set compareWith(fn) {
    if (typeof fn !== "function" && (typeof ngDevMode === "undefined" || ngDevMode)) {
      throw new \u0275RuntimeError(1201, `compareWith must be a function, but received ${JSON.stringify(fn)}`);
    }
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_forms.nbQtf0ZitE-dev.js.map
