...
var intervalProvider = {
  setInterval: function(handler, timeout2) {
    ...
    if (delegate === null || delegate === void 0 ? void 0 : delegate.setInterval) {
      return delegate.setInterval.apply(delegate, __spreadArray4([handler, timeout2], __read4(args)));
    }
    return setInterval.apply(void 0, __spreadArray4([handler, timeout2], __read4(args)));
  },
...
var immediateProvider = {
  setImmediate: function() {
    ...
    return ((delegate === null || delegate === void 0 ? void 0 : delegate.setImmediate) || setImmediate).apply(void 0, __spreadArray5([], __read5(args)));
  },
  clearImmediate: function(handle) {
    var delegate = immediateProvider.delegate;
...
var AsapAction = function(_super) {
  __extends10(AsapAction2, _super);
...
import { __extends as __extends12 } from "tslib";

// node_modules/rxjs/dist/esm5/internal/scheduler/AsyncScheduler.js
import { __extends as __extends11 } from "tslib";
...
var AsyncScheduler = function(_super) {
  __extends11(AsyncScheduler2, _super);
...
var AsapScheduler = function(_super) {
  __extends12(AsapScheduler2, _super);
...
import { __extends as __extends13 } from "tslib";
var QueueAction = function(_super) {
  __extends13(QueueAction2, _super);
...
import { __extends as __extends14 } from "tslib";
var QueueScheduler = function(_super) {
  __extends14(QueueScheduler2, _super);
...
import { __extends as __extends15 } from "tslib";
var AnimationFrameAction = function(_super) {
  __extends15(AnimationFrameAction2, _super);
...
import { __extends as __extends16 } from "tslib";
var AnimationFrameScheduler = function(_super) {
  __extends16(AnimationFrameScheduler2, _super);
...
import { __extends as __extends17 } from "tslib";
var VirtualTimeScheduler = function(_super) {
  __extends17(VirtualTimeScheduler2, _super);
...
var VirtualAction = function(_super) {
  __extends17(VirtualAction2, _super);
...
function callOrApply(fn, args) {
  return isArray(args) ? fn.apply(void 0, __spreadArray6([], __read6(args))) : fn(args);
}
  ...
  return function() {
    ...
    return new Observable(function(subscriber) {
      ...
      if (uninitialized) {
        ...
        callbackFunc.apply(_this, __spreadArray7(__spreadArray7([], __read7(args)), [function() {
          var results = [];
...
function fromEvent(target, eventName, options, resultSelector) {
  ...
  var _a = __read8(isEventTarget(target) ? eventTargetMethods.map(function(methodName) {
...
import { __generator as __generator3 } from "tslib";
...
import { __read as __read9, __spreadArray as __spreadArray8 } from "tslib";
function zip() {
  var args = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    args[_i] = arguments[_i];
    ...
    var _loop_1 = function(sourceIndex2) {
      innerFrom(sources[sourceIndex2]).subscribe(createOperatorSubscriber(subscriber, function(value) {
        ...
        if (buffers.every(function(buffer2) {
          ...
          subscriber.next(resultSelector ? resultSelector.apply(void 0, __spreadArray8([], __read9(result))) : result);
...
import { __read as __read11, __spreadArray as __spreadArray10 } from "tslib";

// node_modules/rxjs/dist/esm5/internal/operators/combineLatest.js
import { __read as __read10, __spreadArray as __spreadArray9 } from "tslib";
function combineLatest2() {
  ...
  var resultSelector = popResultSelector(args);
  return resultSelector ? pipe(combineLatest2.apply(void 0, __spreadArray9([], __read10(args))), mapOneOrManyArgs(resultSelector)) : operate(function(source, subscriber) {
    combineLatestInit(__spreadArray9([source], __read10(argsOrArgArray(args))))(subscriber);
  });
}
...
function combineLatestWith() {
  ...
  return combineLatest2.apply(void 0, __spreadArray10([], __read11(otherSources)));
}
...
import { __read as __read13, __spreadArray as __spreadArray12 } from "tslib";

// node_modules/rxjs/dist/esm5/internal/operators/concat.js
import { __read as __read12, __spreadArray as __spreadArray11 } from "tslib";
function concat2() {
  var args = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    args[_i] = arguments[_i];
  ...
  var scheduler = popScheduler(args);
  return operate(function(source, subscriber) {
    concatAll()(from(__spreadArray11([source], __read12(args)), scheduler)).subscribe(subscriber);
  });
}
...
function concatWith() {
  ...
  return concat2.apply(void 0, __spreadArray12([], __read13(otherSources)));
}
...
import { __read as __read14, __spreadArray as __spreadArray13 } from "tslib";
function endWith() {
  var values = [];
  for (var _i = 0; _i < arguments.length; _i++) {
  ...
  return function(source) {
    return concat(source, of.apply(void 0, __spreadArray13([], __read14(values))));
  };
}
...
import { __read as __read16, __spreadArray as __spreadArray15 } from "tslib";

// node_modules/rxjs/dist/esm5/internal/operators/merge.js
import { __read as __read15, __spreadArray as __spreadArray14 } from "tslib";
function merge2() {
  var args = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    args[_i] = arguments[_i];
  ...
  return operate(function(source, subscriber) {
    mergeAll(concurrent)(from(__spreadArray14([source], __read15(args)), scheduler)).subscribe(subscriber);
  });
}
...
function mergeWith() {
  ...
  return merge2.apply(void 0, __spreadArray15([], __read16(otherSources)));
}
...
import { __read as __read17, __spreadArray as __spreadArray16 } from "tslib";
function onErrorResumeNextWith() {
  ...
  var nextSources = argsOrArgArray(sources);
  return function(source) {
    return onErrorResumeNext.apply(void 0, __spreadArray16([source], __read17(nextSources)));
  };
}
...
import { __read as __read18, __spreadArray as __spreadArray17 } from "tslib";
function raceWith() {
  var otherSources = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    otherSources[_i] = arguments[_i];
  ...
  return !otherSources.length ? identity : operate(function(source, subscriber) {
    raceInit(__spreadArray17([source], __read18(otherSources)))(subscriber);
  });
}
...
import { __read as __read19, __spreadArray as __spreadArray18 } from "tslib";
...
function handleReset(reset, on) {
  ...
  return innerFrom(on.apply(void 0, __spreadArray18([], __read19(args)))).subscribe(onSubscriber);
}
...
import { __read as __read20, __spreadArray as __spreadArray19 } from "tslib";
function withLatestFrom() {
  ...
  return operate(function(source, subscriber) {
    ...
    source.subscribe(createOperatorSubscriber(subscriber, function(value) {
      if (ready) {
        var values = __spreadArray19([value], __read20(otherValues));
        subscriber.next(project ? project.apply(void 0, __spreadArray19([], __read20(values))) : values);
      }
    }));
  });
}
...
import { __read as __read22, __spreadArray as __spreadArray21 } from "tslib";

// node_modules/rxjs/dist/esm5/internal/operators/zip.js
import { __read as __read21, __spreadArray as __spreadArray20 } from "tslib";
function zip2() {
  var sources = [];
  for (var _i = 0; _i < arguments.length; _i++) {
    sources[_i] = arguments[_i];
  ...
  return operate(function(source, subscriber) {
    zip.apply(void 0, __spreadArray20([source], __read21(sources))).subscribe(subscriber);
  });
}
...
function zipWith() {
  ...
  return zip2.apply(void 0, __spreadArray21([], __read22(otherInputs)));
}
export {
...
//# sourceMappingURL=rxjs.DW8gIV_UnO-dev.js.map
