...
var INPUT_SIGNAL_NODE = /* @__PURE__ */ (() => {
  return __spreadProps(__spreadValues({}, SIGNAL_NODE$1), {
    transformFn: void 0,
...
var REACTIVE_LVIEW_CONSUMER_NODE = __spreadProps(__spreadValues({}, REACTIVE_NODE$1), {
...
var TEMPORARY_CONSUMER_NODE = __spreadProps(__spreadValues({}, REACTIVE_NODE$1), {
  consumerIsAlwaysLive: true,
  consumerMarkedDirty: (node) => {
...
function isSignal(value) {
  return typeof value === "function" && value[SIGNAL$1] !== void 0;
}
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_core.F1vIxPLmIb-dev.js.map
